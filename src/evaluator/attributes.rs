...
pub fn get_builtin_attributes(name: &str) -> Vec<&'static str> {
  match name {
    ...
    | "InverseJacobiNC" | "InverseJacobiND" | "InverseJacobiDC" | "StruveH"
    | "StruveL" | "ParabolicCylinderD" | "AngerJ" => {
    ...
    | "Block" | "With" | "Assuming" | "Trace" | "TraceScan" | "Defer"
    | "Compile" | "CompoundExpression" | "Switch" | "Which" | "Catch"
    | "Throw" | "Clear" | "ClearAll" | "Condition" | "Off" | "On"
