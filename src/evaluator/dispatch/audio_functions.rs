...
pub(super) fn dispatch_audio_functions(
  ...
  match name {
    ...
    "AudioQ" => Some(audio::audio_q_ast(args)),
    "AudioNormalize" => Some(audio::edit::audio_normalize_ast(args)),
    "AudioReverse" => Some(audio::edit::audio_reverse_ast(args)),
    "AudioPad" => Some(audio::edit::audio_pad_ast(args)),
    "AudioData" => Some(audio::audio_data_ast(args)),
    "AudioChannels" => Some(audio::audio_channels_ast(args)),
    "AudioLength" => Some(audio::audio_length_ast(args)),
    "AudioSampleRate" => Some(audio::audio_sample_rate_ast(args)),
    "AudioType" => Some(audio::audio_type_ast(args)),
