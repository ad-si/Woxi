...
/// `ColorData[35, "ColorList"]` — ten colors running orange through red by
/// way of yellow-green and indigo, likewise cycling.
const SCHEME_35: [(f64, f64, f64); 10] = [
  (205.0 / 255.0, 79.0 / 255.0, 18.0 / 255.0),
  (255.0 / 255.0, 185.0 / 255.0, 24.0 / 255.0),
  (244.0 / 255.0, 203.0 / 255.0, 35.0 / 255.0),
  (243.0 / 255.0, 250.0 / 255.0, 146.0 / 255.0),
  (105.0 / 255.0, 151.0 / 255.0, 102.0 / 255.0),
  (79.0 / 255.0, 120.0 / 255.0, 88.0 / 255.0),
  (76.0 / 255.0, 73.0 / 255.0, 140.0 / 255.0),
  (69.0 / 255.0, 47.0 / 255.0, 96.0 / 255.0),
  (224.0 / 255.0, 26.0 / 255.0, 53.0 / 255.0),
  (204.0 / 255.0, 15.0 / 255.0, 19.0 / 255.0),
];
