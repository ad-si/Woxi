...
pub fn get_arg_count_range(name: &str) -> Option<(usize, usize)> {
  match name {
    ...
    "ContainsAll" => Some((2, 2)),
    "ContainsAny" => Some((2, 2)),
    "ContainsNone" => Some((2, 2)),
    ...
    "DeleteCases" => Some((2, 4)),
    "DeleteDuplicates" => Some((1, 1)),
    "DeleteDuplicatesBy" => Some((2, 2)),
