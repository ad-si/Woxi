...
pub fn get_arg_count_range(name: &str) -> Option<(usize, usize)> {
  match name {
    ...
    "Fibonacci" => Some((1, 2)),
    "FileNameDepth" => Some((1, 2)),
    "FileNameDrop" => Some((1, 3)),
    "FileNameJoin" => Some((1, 2)),
    "FileNames" => Some((0, 3)),
    "FileNameSplit" => Some((1, 2)),
    "FileSize" => Some((1, 1)),
    "FileNameTake" => Some((1, 3)),
    ...
    "HorizontalGauge" => Some((1, usize::MAX)),
    ...
    "TeXForm" => Some((1, 1)),
    "Convert`TeX`ExpressionToTeX" => Some((1, 1)),
    "TextCases" => Some((2, 3)),
